...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_EBYTE_E73_TBB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_EBYTE_E73_TBB_NRF52832, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_STATUS_SECURITY_ENABLED, 1);
